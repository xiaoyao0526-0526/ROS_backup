...
(cl:defmethod cl:initialize-instance :after ((m <Location_monitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Location_monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pro001-msg:<Location_monitor> is deprecated: use pro001-msg:Location_monitor instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pro001-msg:name-val is deprecated.  Use pro001-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pro001-msg:distance-val is deprecated.  Use pro001-msg:distance instead.")
  (distance m))

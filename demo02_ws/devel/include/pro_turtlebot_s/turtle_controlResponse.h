...
bool operator==(const ::pro_turtlebot_s::turtle_controlResponse_<ContainerAllocator1> & lhs, const ::pro_turtlebot_s::turtle_controlResponse_<ContainerAllocator2> & rhs)
{

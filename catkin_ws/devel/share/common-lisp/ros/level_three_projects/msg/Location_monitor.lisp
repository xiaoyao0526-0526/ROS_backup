...
(cl:defmethod cl:initialize-instance :after ((m <Location_monitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Location_monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name level_three_projects-msg:<Location_monitor> is deprecated: use level_three_projects-msg:Location_monitor instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader level_three_projects-msg:name-val is deprecated.  Use level_three_projects-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader level_three_projects-msg:distance-val is deprecated.  Use level_three_projects-msg:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Location_monitor>)))
  ...
  "level_three_projects/Location_monitor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Location_monitor)))
  "Returns string type for a message object of type 'Location_monitor"
  "level_three_projects/Location_monitor")

...
(cl:defmethod cl:initialize-instance :after ((m <Location_monitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Location_monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name level_three-msg:<Location_monitor> is deprecated: use level_three-msg:Location_monitor instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader level_three-msg:name-val is deprecated.  Use level_three-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Location_monitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader level_three-msg:distance-val is deprecated.  Use level_three-msg:distance instead.")
  (distance m))

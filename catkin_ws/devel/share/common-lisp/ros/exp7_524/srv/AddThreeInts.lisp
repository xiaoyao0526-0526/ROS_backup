...
(cl:defmethod cl:initialize-instance :after ((m <AddThreeInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddThreeInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exp7_524-srv:<AddThreeInts-request> is deprecated: use exp7_524-srv:AddThreeInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddThreeInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp7_524-srv:a-val is deprecated.  Use exp7_524-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddThreeInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp7_524-srv:b-val is deprecated.  Use exp7_524-srv:b instead.")
  (b m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <AddThreeInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp7_524-srv:c-val is deprecated.  Use exp7_524-srv:c instead.")
  (c m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddThreeInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddThreeInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exp7_524-srv:<AddThreeInts-response> is deprecated: use exp7_524-srv:AddThreeInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddThreeInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exp7_524-srv:sum-val is deprecated.  Use exp7_524-srv:sum instead.")
  (sum m))

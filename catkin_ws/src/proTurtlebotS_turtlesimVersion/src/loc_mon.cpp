...
int main(int argc, char** argv)
{
  ...
  //ros::Subscriber sub = nh.subscribe("/turtle1/pose", 10, &LandmarkMonitor::OdomCallback, &monitor);
  ros::Subscriber sub = nh.subscribe("odom", 10, &LandmarkMonitor::OdomCallback, &monitor);//functions
